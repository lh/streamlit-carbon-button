...
if carbon_button(
    "Purple Button", icon=CarbonIcons.STAR, colors=purple_colors, key="purple"
):
...
if carbon_button(
    "Teal Button", icon=CarbonIcons.SUCCESS, colors=teal_colors, key="teal"
):
...
if carbon_button(
    "Minimal Grey", icon=CarbonIcons.DOCUMENT, colors=grey_colors, key="grey"
):
